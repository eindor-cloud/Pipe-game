...
//-----------------------------------------------------------------------------
void Ball::move( Object &player)
{
    //update(Time());
    //m_dir = player.get_dir();
    //m_body->ApplyForce(b2Vec2(toVector(m_dir).x*100, toVector(m_dir).y*100000), b2Vec2(m_sprite.getPosition().x, m_sprite.getPosition().y), true);
    //m_body->ApplyLinearImpulse(b2Vec2(toVector(m_dir).x*10000 , toVector(m_dir).y*10000 ), b2Vec2(m_sprite.getPosition().x, m_sprite.getPosition().y), true);
}
//=============================================================================
