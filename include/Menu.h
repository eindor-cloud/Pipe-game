...
private:
	typedef tuple<Sprite&, unique_ptr<Command>, vector<shared_ptr<Texture>>> option; 
			//every option is a sprite, his textures for mouse hover and command  
	typedef tuple<char&, char&, float&> user_selection; //user selection is the data needed for the game
	RenderWindow& m_window;
	vector<option> m_options;
	user_selection m_selection;
	Sprite m_background, m_exit, m_start;
